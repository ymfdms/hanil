...
class RankController extends Controller
{
    public function rank(){
        ...
        return view('rank',compact('selected','rank_name1','rank_name2','rank_name3','rank_name4','rank_name5','post_id','answer_count','inout','count','reversed','correct_sum'));
    }
    ...
    public function post_select(){
        ...
        return view('rank',compact('selected','rank_name1','rank_name2','rank_name3','rank_name4','rank_name5','post_id','answer_count','correct_sum','inout','count','reversed'));
    }
    ...
    public function answer_select(){
        ...
        return view('rank',compact('selected','rank_name1','rank_name2','rank_name3','rank_name4','rank_name5','answer_id','answer_count','inout','correct_sum','answer_count','count','reversed'));
    }
}
