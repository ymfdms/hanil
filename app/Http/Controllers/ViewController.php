...
class ViewController extends Controller
{
    ...
    public function post()
    {
        ...
        $result2=new Result2;
        $answer_count=Result2::where('user_id',Auth::id())->sum('answer_count'); //ヘッダー用、回答数
        return view('post',compact('answer_count','inout'));
    }
    public function rank()
    {
        ...
        $result2=new Result2;
        $answer_count=Result2::where('user_id',Auth::id())->sum('answer_count'); //ヘッダー用、回答数
        return view('rank',compact('answer_count','inout'));
    }
    public function mypage()
    {
        ...
        $result2=new Result2;
        $answer_count=Result2::where('user_id',Auth::id())->sum('answer_count'); //ヘッダー用、回答数
        return view('mypage',compact('answer_count','inout'));
    }
    ...
    public function answer(Request $request)
    {
        ...
        return view('answer',compact('data1','data2','data3','data4','data_q','number','answer_count','inout'));
    }
    ...
    public function correct(Request $request){ //正解したとき、この関数が動く
        ...
        if($number>10){
            ...
            if(!array_search('正解',$flattened)==false){
                ...
                return view('check',compact('result','number','answer_count','inout','value'));
            }
            else{
            ...
            $result_db->save(); //ここまでDB格納
            $request->session()->regenerateToken();
            return view('check',compact('result','number','answer_count','inout'));
        }
        else{
            ...
            $request->session()->regenerateToken();
            return view('answer',compact('data1','data2','data3','data4','data_q','session_key','session_all','number','answer_count','inout')); 
        }
    }
    ...
    public function incorrect(Request $request){ //正解したとき、この関数が動く
        ...
        if($number>10){
            ...
            $data_q=$data_array[$data_key];
            $request->session()->regenerateToken();
            return view('answer',compact('value','data1','data2','data3','data4','data_q','session_key','session_all','number','answer_count','inout')); 
        }
    }
