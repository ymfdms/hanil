                        ...
                        <div class="purple">
                            <div class="post-center">
                                <div class="post-group">
                                    ...
                                    <input type="text" id="korean" name="korean" class="korean-input" pattern="[가-힣　\?]+" title="ハングルと半角の?、全角スペースのみで入力してください" required maxlength="10">
                                    <p class="post-input">日本語</p>
                                    <input type="text" id="japanese" name="japanese" class="japanese-input" pattern="[ぁ-んァ-ヶ亜-熙　\?]+" title="ひらがな、カタカナ、漢字と半角の?、全角スペースのみで入力してください" required maxlength="10">
                                </div>
                            </div>
